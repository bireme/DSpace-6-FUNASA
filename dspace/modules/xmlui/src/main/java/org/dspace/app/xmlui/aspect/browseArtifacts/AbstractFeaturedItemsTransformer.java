 ...
 */
public abstract class AbstractFeaturedItemsTransformer extends AbstractDSpaceTransformer implements CacheableProcessingComponent {

    private static final Message view_more = message("xmlui.ArtifactBrowser.AbstractFeaturedItemsTransformer.featured_items_more");
    private static final Logger log = Logger.getLogger(AbstractFeaturedItemsTransformer.class);
     ...
     */
    protected void getFeaturedItems(DSpaceObject dso) {
        ...
        try {
            ...
            queryArgs.setQuery("paho.isfeatured:1");
            DiscoveryConfiguration discoveryConfiguration = SearchUtils.getDiscoveryConfiguration(dso);
            
            // Usa los mismos parametros para el recent que para el featured
            // no hay featured para comunidades y colecciones
            ...
            log.error("Caught SearchServiceException while retrieving featured items for: " + (dso == null ? "home page" : dso.getHandle()), se);
        }
    }
    ...
    protected void addViewMoreLink(Division recentSubmissionDiv, DSpaceObject dso) throws WingException {
        ...
        recentSubmissionDiv.addPara("featured-submission-view-more", "featuredSubmissionViewMore").addXref(url).addContent(view_more);
    }
