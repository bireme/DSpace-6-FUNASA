 ...
 */
public class FeaturedSubmissionUtils {
     ...
     * @return result.
     */
    public static DiscoverResult getFeaturedSubmittedItems(Context context, DSpaceObject dso, int offset) {
        try {
            ...
            DiscoveryRecentSubmissionsConfiguration recentSubmissionConfiguration = getFeaturedSubmissionConfiguration(discoveryConfiguration);
    ...
    public static DiscoveryRecentSubmissionsConfiguration getFeaturedSubmissionConfiguration(DSpaceObject dso) {
        return getFeaturedSubmissionConfiguration(getDiscoveryConfiguration(dso));

    }
    public static DiscoveryRecentSubmissionsConfiguration getFeaturedSubmissionConfiguration(DiscoveryConfiguration discoveryConfiguration) {
