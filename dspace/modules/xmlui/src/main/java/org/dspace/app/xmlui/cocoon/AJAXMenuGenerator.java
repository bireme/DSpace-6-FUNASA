...
public class AJAXMenuGenerator extends AbstractGenerator
{
        ...
        throws IOException, SAXException, ProcessingException
    {
        try {
            ...
            String localeDeCS = parameters.getParameter("localeDeCS",null);
            ...
            Choices result = choiceAuthorityService.getMatches(field, query, collection, start, limit, localeDeCS, true);
