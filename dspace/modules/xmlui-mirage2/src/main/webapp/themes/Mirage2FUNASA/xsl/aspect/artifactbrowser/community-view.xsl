...
<xsl:stylesheet
    ...
    <xsl:template name="communitySummaryView-DIM">
     ...
     <!-- BIREME customization - A community rendered in the detailView pattern; default way of viewing a community. -->
    <xsl:template name="communityDetailView-DIM">
        <div class="detail-view">&#160;
            ...
            <xsl:apply-templates select="./mets:fileSec/mets:fileGrp[@USE='LOGO']" mode="second-level"/>
