            ...
            <h4 class="artifact-title">
                ...
                <xsl:choose>
                  ...
                  <xsl:when test="contains($titlecoll,'Multi')">
                    <xsl:text>icoMultimidia</xsl:text>
                  </xsl:when>
                  <xsl:when test="contains($titlecoll,'Planeja')">
                    <xsl:text>icoProjetos</xsl:text>
                  </xsl:when>
                  <xsl:when test="contains($titlecoll,'Cientí')">
                    <xsl:text>icoProducaoCientifica</xsl:text>
                  </xsl:when>
                  <xsl:when test="contains($titlecoll,'Educa')">
                    <xsl:text>icoProducoesEducacionais</xsl:text>
                  </xsl:when>
                ...
                <img src="{$theme-path}/images/{$ico}.png" class="icocoll" />
