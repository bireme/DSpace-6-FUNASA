...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:options">
        <div id="ds-options" class="word-break hidden-print">
            <xsl:if test="not(contains(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI'], 'discover')) and string-length(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI']) > 0">
           ...
           <xsl:apply-templates select="*[@n='discovery']"/>
           <xsl:apply-templates select="*[not(@n='discovery')]"/>
    ...
    <xsl:template match="dri:options/dri:list/dri:head" priority="3">
        ...
        <xsl:choose>
        <xsl:when test = "../@n='account' and //dri:document/dri:meta/dri:userMeta/@authenticated = 'no'">
        </xsl:when>
        <xsl:otherwise>
