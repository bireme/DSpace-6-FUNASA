...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM">
        ...
        <script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=598be57fd85a710012ca4ced&amp;product=inline-share-buttons"></script>
        ...
        <xsl:template name="itemDetailView-DIM">
                ...
                <div class="item-summary-view-metadata">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <xsl:call-template name="itemSummaryView-DIM-titlealt"/>
                            <xsl:call-template name="itemSummaryView-DIM-series"/>
                            <xsl:call-template name="itemSummaryView-DIM-subject"/>
                            <xsl:call-template name="itemSummaryView-DIM-categories"/>
                            <xsl:call-template name="itemSummaryView-DIM-URI"/>
                            <xsl:call-template name="itemSummaryView-DIM-Citation"/>

                            <!-- Display relation to Legislation collection -->
                            <xsl:call-template name="relation-altera" />
                            <xsl:call-template name="relation-cambiado-por" />

                            <xsl:call-template name="relation-complementa" />
                            <xsl:call-template name="relation-complementado-por" />

                            <xsl:call-template name="relation-excluye" />
                            <xsl:call-template name="relation-excluido-por" />

                            <xsl:call-template name="relation-incluye" />
                            <xsl:call-template name="relation-incluido-en" />

                            <xsl:call-template name="relation-revoga" />
                            <xsl:call-template name="relation-revogado-por" />

                            <xsl:call-template name="itemSummaryView-collections"/>
                            <xsl:call-template name="legend-contact-for-no-files" />

                            <!-- Display relation to Educational resources -->
                            <xsl:call-template name="relation-ebasepara" />
                            <xsl:call-template name="relation-epartede" />
                            <xsl:call-template name="relation-eversaode" />
                            <xsl:call-template name="relation-requer" />

                        </div>
                    </div>
                </div>

                <xsl:call-template name="itemYouTubeViewer" />
            ...
            <xsl:template name="itemYouTubeViewer">
                <xsl:if test="dim:field[@element='youtubeid'][not(@qualifier)]">
                    <div class="simple-item-view-description item-page-field-wrapper table">
                        <h5>Visor de YouTube</h5>
                        <div>
                            <xsl:for-each select="dim:field[@element='youtubeid'][not(@qualifier)]">
                                <xsl:choose>
                                    <xsl:when test="node()">
                                        <!-- <xsl:copy-of select="node()"/> -->
                                        <xsl:variable name="id" select="node()" />
                                        <!-- <xsl:value-of select="$id" /> -->

                                        <iframe width="550" height="380" src="//www.youtube.com/embed/{$id}" frameborder="0" allowfullscreen="true"></iframe>
                                ...
                                <xsl:if test="count(following-sibling::dim:field[@element='youtubeid'][not(@qualifier)]) != 0">
                                    <div class="spacer">&#160;</div>
                                </xsl:if>
                            </xsl:for-each>
                            <xsl:if test="dim:field[@element='youtubeid'][not(@qualifier)] &gt; 1">
                                <div class="spacer">&#160;</div>
                            </xsl:if>
                        </div>
                    </div>
            ...
            <xsl:template name="legend-contact-for-no-files">
            
            
              <xsl:if test="not(//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file)">
                <xsl:if test="not(//dim:field[@element='youtubeid'][not(@qualifier)])">

                    <xsl:variable name="mailinfo" select="dim:field[@element='identifier' and @qualifier='uri']/text()" />
            ...
            <xsl:template name="itemSummaryView-DIM-thumbnail">
                <div class="thumbnail">
                    ...
                    <xsl:template name="itemSummaryView-DIM-abstract">
                        <xsl:if test="dim:field[@element='description' and (@qualifier='abstract' or @qualifier='notes')]">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5 class="visible-xs"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-abstract</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='description' and (@qualifier='abstract' or @qualifier='notes')]">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                                <xsl:copy-of select="node()"/>
                                            </xsl:when>
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='description' and (@qualifier='abstract' or @qualifier='notes')]) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='description' and (@qualifier='abstract' or @qualifier='notes')]) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <!-- Display relation to Legislation collection -->
                    <xsl:template name="relation-altera">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='altera']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-altera</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='altera']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                                ...
                                                <a href="{$metsDoc/mets:METS/@OBJID}">
                                                    <xsl:value-of select="$metsDoc//dim:field[@element='title'][1]" />
                                                </a>
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='altera']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='altera']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-cambiado-por">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='cambiadopor']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-cambiadopor</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='cambiadopor']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='cambiadopor']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='cambiadopor']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-complementa">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='complementa']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-complementa</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='complementa']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='complementa']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='complementa']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-complementado-por">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='complementadopor']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-complementadopor</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='complementadopor']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='complementadopor']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='complementadopor']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-excluye">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='excluye']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-excluye</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='excluye']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='excluye']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='excluye']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-excluido-por">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='excluidopor']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-excluidopor</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='excluidopor']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='excluidopor']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='excluidopor']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-incluye">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='incluye']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-incluye</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='incluye']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='incluye']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='incluye']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-incluido-en">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='incluidoen']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-incluidoen</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='incluidoen']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='incluidoen']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='incluidoen']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-revoga">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='revoga']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-revoga</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='revoga']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='revoga']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='revoga']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-revogado-por">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='revogadopor']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-revogadopor</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='revogadopor']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='revogadopor']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='revogadopor']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <!-- Display relation to Educational resources -->
                    <xsl:template name="relation-ebasepara">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='ebasepara']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-ebasepara</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='ebasepara']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='ebasepara']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='ebasepara']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-epartede">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='epartede']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-epartede</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='epartede']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='epartede']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='epartede']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-eversaode">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='eversaode']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-eversaode</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='eversaode']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='eversaode']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='eversaode']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="relation-requer">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='requer']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-requer</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='requer']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                        ...
                                        <xsl:if test="count(following-sibling::dim:field[@element='relation' and @qualifier='requer']) != 0">
                                            <div class="spacer">&#160;</div>
                                        </xsl:if>
                                    </xsl:for-each>
                                    <xsl:if test="count(dim:field[@element='relation' and @qualifier='requer']) &gt; 1">
                                        <div class="spacer">&#160;</div>
                                    </xsl:if>
                                </div>
                            </div>
                    ...
                    <xsl:template name="itemSummaryView-DIM-titlealt">
                        <xsl:if test="dim:field[@element='title' and @qualifier='alternative']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-othertitle</i18n:text></h5>
                                <div>
                    ...
                    <xsl:template name="itemSummaryView-DIM-subject">
                        <xsl:if test="dim:field[@element='subject'and @mdschema='dc']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-subject</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='subject' and @mdschema='dc']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                                <xsl:variable name="value" select="node()" />
                                                <a href="../../browse?value={$value}&amp;type=subject"><xsl:copy-of select="node()"/></a>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>; </xsl:text>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <xsl:if test="count(following-sibling::dim:field[@element='subject' and @mdschema='dc']) != 0">
                                            <xsl:text>; </xsl:text>
                                        </xsl:if>
                                    </xsl:for-each>
                    ...
                    <xsl:template name="itemSummaryView-DIM-categories">
                        <xsl:if test="dim:field[@element='subject'and @mdschema='paho']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-category</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='subject' and @mdschema='paho']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                                <xsl:variable name="value" select="node()" />
                                                <a href="../../browse?value={$value}&amp;type=category"><xsl:copy-of select="node()"/></a>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>; </xsl:text>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <xsl:if test="count(following-sibling::dim:field[@element='subject' and @mdschema='paho']) != 0">
                                            <xsl:text>; </xsl:text>
                                        </xsl:if>
                                    </xsl:for-each>
                    ...
                    <xsl:template name="itemSummaryView-DIM-series">
                        <xsl:if test="dim:field[@element='relation' and @qualifier='ispartofseries']">
                            <div class="simple-item-view-description item-page-field-wrapper table">
                                <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-ispartofseries</i18n:text></h5>
                                <div>
                                    <xsl:for-each select="dim:field[@element='relation' and @qualifier='ispartofseries']">
                                        <xsl:choose>
                                            <xsl:when test="node()">
                                                <xsl:variable name="serie" select="node()" />
                                                <a href="../../browse?value={$serie}&amp;type=serie"><xsl:copy-of select="node()"/></a>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>&#160;</xsl:text>
                                            </xsl:otherwise>
