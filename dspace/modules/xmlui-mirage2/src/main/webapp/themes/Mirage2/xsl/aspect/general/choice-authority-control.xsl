...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="addLookupLangButtons">
     ...
     <div class="col-md-4">
      ...
      <input type="button" name="{concat('lookup_',@n)}_es" class="pull-right ds-button-field btn btn-default ds-add-button" >
        <xsl:attribute name="value">
          <xsl:text>Buscar</xsl:text>
        </xsl:attribute>
        <xsl:attribute name="onClick">
          <xsl:text>javascript:DSpaceChoiceLookupDeCS('</xsl:text>
          <!-- URL -->
          <xsl:value-of select="concat($context-path,'/admin/lookup')"/>
          <xsl:text>', '</xsl:text>
          <!-- field -->
      ...
      <div class="col-md-4">
       ...
       <input type="button" name="{concat('lookup_',@n)}_en" class="pull-right ds-button-field btn btn-default ds-add-button" >
        <xsl:attribute name="value">
      ...
      <div class="col-md-4">
       <input type="button" name="{concat('lookup_',@n)}_pt" class="pull-right ds-button-field btn btn-default ds-add-button" >
        <xsl:attribute name="value">
