                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <div id="main-container" class="container">
                                ...
                                <div class="row row-offcanvas row-offcanvas-right">
                                <div class="horizontal-slider clearfix">
                                <div class="text-right"> <i class="fas fa-angle-up voltar-topo"></i> <a class="voltar-topo-a" href="#mainbody"><i18n:text>xmlui.home.gotop</i18n:text></a> </div>
                                </div>
                                </div>      
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <nav class="" id="footer-navigation">
                          <h3>Atuação</h3> 
                          <ul class="listagem-links"> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/funasa"><span> A Funasa</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/programas-institucionais"><span> Programas Institucionais</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/legislacao"><span> Legislação</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/licitacoes-da-funasa"><span> Licitações e Contratações</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/convenios1"><span> Convênios</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/ted"><span> Termos de Execução Descentralizada (TED)</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/consultas-publicas"><span> Consultas Públicas</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/editais"><span> Editais</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/biblioteca-eletronica"><span> Biblioteca Eletrônica</span></a> </li> 
                          <li> <a href="http://www.funasa.gov.br/web/guest/museu-funasa"><span> Museu Funasa</span></a> </li> 
                          </ul> </nav>
                    ...
                    <div class="col-sm-3">
                        ...
                        <h3>Serviços</h3>
                        <ul class="listagem-links"> 
                        <li> <a href="/perguntas-frequentes" title="Perguntas Frequentes" target="_self">Perguntas Frequentes</a> </li> 
                        <li> <a href="/enderecos" title="Contatos" target="_self">Contatos</a> </li> 
                        <li> <a href="/documents/20182/24223/Portf%C3%B3lio+de+Servi%C3%A7os+Funasa" title="Serviços" target="_blank">Serviços</a> </li> 
                        <li> <a href="/dados-abertos" title="Dados Abertos" target="_self">Dados Abertos</a> </li> 
                        <li> <a href="/correio" title="Webmail" target="_blank">Webmail</a> </li> 
                        <li> <a href="/conecta" title="Conecta" target="_blank">Conecta</a> </li> 
                        </ul>
                        </nav>
                     </div>   
                     ...
                     <div class="col-sm-3">
                        ...
                        <ul class="listagem-links"> 
                        <li> <a href="https://pt-br.facebook.com/funasa.oficial/" title="Facebook" target="_blank"> Facebook </a> </li> 
                        <li> <a href="https://www.instagram.com/funasa_oficial/" title="Instagram" target="_blank"> Instagram </a> </li> 
                        <li> <a href="https://www.youtube.com/user/Funasaoficial" title="Youtube" target="_blank"> Youtube </a> </li> 
                        <li> <a href="https://twitter.com/funasa" title="Twitter" target="_blank"> Twitter </a> </li>
                        <li> <a href="https://soundcloud.com/funasaoficial" title="SoundCloud" target="_blank"> SoundCloud </a> </li>
                        <li> <a href="https://www.flickr.com/people/funasaoficial" title="Flickr" target="_blank"> Flickr </a> </li>
                        </ul>
                        </nav>
                     </div>   
                        ...
                        <fieldset>
                             ...
                             <div class="searchgroup">
                                ...
                                <!--<xsl:variable name="total">
                                           <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='itemsinarchive'][@qualifier='repository']"/>
                                </xsl:variable> -->
                                ...
                                <div class="col-xs-12 col-md-12">
                                  <div class="btn-group btn-group-xs" role="group">
                                      <xsl:for-each select="//dri:div[@id='aspect.browseArtifacts.HomeSearchBand.div.total-items']/dri:div/dri:p">
                                        <xsl:variable name="expression"><xsl:value-of select="./text()"/></xsl:variable>
                                        <button type="button" class="btn btn-info" onclick="location.href='{$context-path}/discover?query={$expression}'"><xsl:value-of select="$expression" /></button>
                                      </xsl:for-each>
                                  </div>
                                </div>
                                </div>-->
